...
import com.jl.bean.TradeProvinceOrderBean;
...
/**
 * @Package com.jl.DwsTradeProvinceOrderWindow
 * @Author jia.le
...
// 最大并发检查点数
        ...
        DataStreamSource<String> kafkaSource = KafkaUtil.getKafkaSource(env, "dwd_trade_order_detail", "gor001");
