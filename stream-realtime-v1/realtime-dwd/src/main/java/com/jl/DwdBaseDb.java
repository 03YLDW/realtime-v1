...
import com.jl.util.FlinkSinkUtil;
...
public class DwdBaseDb {
    ...
    public static void main(String[] args) {
        ...
        MySqlSource<String> mySqlSource = MySqlSource.<String>builder()
                .hostname("cdh03")
                .port(3306)
                .databaseList("realtime_dim") // 设置捕获的数据库， 如果需要同步整个数据库，请将 tableList 设置为 ".*".
                .tableList("realtime_dim.table_process_dwd") // 设置捕获的表
                .username("root")
                .password("root")
