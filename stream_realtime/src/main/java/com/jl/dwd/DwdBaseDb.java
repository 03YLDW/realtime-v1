...
import com.jl.function.BaseDbTableProcessFunction;
...
//        kafkaStrDS.print();
        ...
        SingleOutputStreamOperator<JSONObject> dbObjDS = jsonObjDS.filter(new FilterFunction<JSONObject>() {
            @Override
...
//        jsonObjDS.print();
        ...
        MySqlSource<String> mySqlSource = FlinkSourceUtil.getMySqlSource("realtime_dim","table_process_dwd");
